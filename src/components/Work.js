...
import Img3 from '../assets/chatme.png'
    ...
    <div className='container mx-auto relative top-40'>
      <div className='flex  flex-col lg:flex-row gap-x-10 '>
        ...
        <div className='flex-1'>
            ...
            Projects</h2>
          <p className='max-w-sm  font-mono text-white '>All the projects are build with latest web development technologies . Check these projects and their github for code review . <br/> Please check my Github Account to see more projects I made.</p>
        ...
        <div className='flex-1 group relative overflow-hidden border-2
        ...
        <div className='flex-1 group relative overflow-hidden border-2 shadow-outer-project
